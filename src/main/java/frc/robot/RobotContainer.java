...
public class RobotContainer {
  ...
  public final SwerveSubsystem m_swerveSubsystem = new SwerveSubsystem(new File(Filesystem.getDeployDirectory(),
      "swerve"));
  public final ShooterSubsystem m_rackSubsystem = new ShooterSubsystem();
  ...
  private void configureBindings() {
    ...
    m_driverController.a().whileTrue(m_rackSubsystem.run(5));
    m_driverController.b().whileTrue(m_rackSubsystem.run(-5));
    m_driverController.x().whileTrue(m_intakeSubsystem.run(6));
    m_driverController.y().whileTrue(m_intakeSubsystem.run(-6));
  }
